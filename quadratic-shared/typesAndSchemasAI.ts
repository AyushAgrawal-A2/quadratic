...
export type BedrockAnthropicModel = 'us.anthropic.claude-sonnet-4-6' | 'anthropic.claude-haiku-4-5-20251001-v1:0';
...
const AIToolArgsArraySchema: z.ZodType<AIToolArgsArray> = z.lazy(() =>
  z.object({
    type: z.literal('array').or(z.tuple([z.literal('array'), z.literal('null')])),
