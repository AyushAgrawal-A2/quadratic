...
> = {
  ...
  'team-plan': {
    ...
    Form: (props) => {
      ...
      const isSubmittingBusiness = formActionUrl.includes(`${props.id}=business`);
      ...
      return (
        <Question title={props.title} subtitle={props.subtitle}>
          <QuestionForm className="flex flex-col gap-4">
            <div className="grid grid-cols-3 items-stretch gap-4">
              ...
              <PlanCard plan="pro" aiIncludedUsage={billingConfig.isLoaded ? billingConfig.proAiAllowance : undefined}>
                <Button
                  type="submit"
                  name={props.id}
                  value="pro"
...
export function Questions() {
  ...
  return (
    <div ref={scrollRef} className="h-full overflow-y-auto overflow-x-hidden">
      <div className={cn('mx-auto flex flex-col gap-8 pt-8', currentId === 'team-plan' ? 'max-w-4xl' : 'max-w-xl')}>
        <Logo />
