import { SpinnerIcon, WarningIcon } from '@/shared/components/Icons';
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Allow users who hit their included usage limit to use additional AI.
          </p>
        </div>
        <div className="flex flex-shrink-0 items-center gap-2">
          <SpinnerIcon className={cn('text-primary', isUpdatingOnDemand ? '' : 'invisible opacity-0')} />
          <Switch
            id={toggleId}
